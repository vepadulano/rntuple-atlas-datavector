...
int main()
{
    ...
    std::cout << "f1: " << desc.GetFieldDescriptor(desc.FindFieldId("f1")).GetTypeName() << "\n";
    std::cout << "f2: " << desc.GetFieldDescriptor(desc.FindFieldId("f2")).GetTypeName() << "\n";
    std::cout << "f3: " << desc.GetFieldDescriptor(desc.FindFieldId("f3")).GetTypeName() << "\n";
    std::cout << "typeinfo: " << typeid(AtlasLikeDataVector<int>).name() << "\n";
    std::cout << "RField<T>::TypeName: " << ROOT::Experimental::RField<AtlasLikeDataVector<int>>::TypeName() << "\n";
}
